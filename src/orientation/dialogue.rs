...
use crate::tutorial::stages::OrientationStage;
...
pub fn message(stage: OrientationStage) -> PongMessage {
    ...
    match stage {
        Boot => PongMessage {
            ...
            voice_path: Some("audio/pong/boot.ogg"),
        },
        ...
        Welcome => PongMessage {
            ...
            voice_path: Some("audio/pong/welcome.ogg"),
        },
        ...
        Movement => PongMessage {
            ...
            voice_path: Some("audio/pong/movement.ogg"),
        },
        ...
        Camera => PongMessage {
            ...
            voice_path: Some("audio/pong/camera.ogg"),
        },
        ...
        Interaction => PongMessage {
            ...
            voice_path: Some("audio/pong/interaction.ogg"),
        },
        ...
        Authentication => PongMessage {
            ...
            voice_path: Some("audio/pong/authentication.ogg"),
        },
        ...
        PacketPickup => PongMessage {
            ...
            voice_path: Some("audio/pong/packet_pickup.ogg"),
        },
        ...
        PacketDelivery => PongMessage {
            ...
            voice_path: Some("audio/pong/packet_delivery.ogg"),
        },
        ...
        Infection => PongMessage {
            ...
            voice_path: Some("audio/pong/infection.ogg"),
        },
        ...
        Quarantine => PongMessage {
            ...
            voice_path: Some("audio/pong/quarantine.ogg"),
        },
        ...
        Freeze => PongMessage {
            ...
            voice_path: Some("audio/pong/freeze.ogg"),
        },
        ...
        Meeting => PongMessage {
            ...
            voice_path: Some("audio/pong/meeting.ogg"),
        },
        ...
        Voting => PongMessage {
            ...
            voice_path: Some("audio/pong/voting.ogg"),
        },
        ...
        ChatRules => PongMessage {
            ...
            voice_path: Some("audio/pong/chat_rules.ogg"),
        },
        ...
        Graduation => PongMessage {
            ...
            voice_path: Some("audio/pong/graduation.ogg"),
        },
        ...
        Finished => PongMessage {
            ...
            voice_path: Some("audio/pong/finished.ogg"),
        },
    }
}
