...
pub struct OrientationObjective {
...
impl Default for OrientationObjective {
    fn default() -> Self {
        Self::from_stage(OrientationStage::default())
    }
}

impl OrientationObjective {
    /// Creates the appropriate objective for the supplied tutorial stage.
    pub fn from_stage(stage: OrientationStage) -> Self {
